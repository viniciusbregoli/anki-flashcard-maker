...
class AudioDownloader:
    ...
    async def download_pronunciation(self, word: str, language: str = "de", card_id: int = None) -> bool:
        """
...
async def download_pronunciation(word: str, language: str = "de", card_id: int = None) -> bool:
    """
    ...
    if not api_key:
        print("  ⚠️  API_KEY not found in environment variables. Skipping audio download.")
        return False
